...
#
# Fine-tunes BOTH the GRPO watermarked model AND the base model on clean
# (non-watermarked) Alpaca data using LoRA, evaluating implicit watermark
# retention at: steps = 0, 100, 250, 500, 1000.
#
# Usage:
#   bash run_finetune_robustness.sh
#   bash run_finetune_robustness.sh --grpo-model grpo_models/my_run/final_model
#   bash run_finetune_robustness.sh --skip-base   # GRPO only
# ============================================================================
